...
export class DashboardComponent extends BaseWidgetDirective{
  ...
  public activeItem: SidebarItem = this.menuItems[0];
  public profile: string = 'https://static.vecteezy.com/system/resources/previews/027/312/306/large_2x/portrait-of-a-dj-with-headphone-isolated-essential-workers-avatar-icons-characters-for-social-media-and-networking-user-profile-website-and-app-3d-render-illustration-png.png';
